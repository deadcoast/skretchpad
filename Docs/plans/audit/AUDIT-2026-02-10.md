...
- [ ] Architecture documentation refresh (low-priority documentation track).
...
Treat findings below as historical context; current remediation state is captured in the addendum above.
