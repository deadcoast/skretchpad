...
**Used in**: [`Editor.svelte:425`](04_Editor.svelte.md) - Content change handler (300ms delay)
...
- **[Editor.svelte](04_Editor.svelte.md)** - Content change debouncing (line 425)

### Store Usage

- **[editor.ts](13_editor.ts.md)** - State update debouncing
- **[theme.ts](08_theme.ts.md)** - Theme change debouncing
