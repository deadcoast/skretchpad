...
**Used by**: [`StatusBar.svelte`](17_StatusBar.svelte.md)
...
**Actual implementation**: [`StatusBar.svelte`](17_StatusBar.svelte.md)
...
- **[StatusBar.svelte](17_StatusBar.svelte.md)** - Displays status bar items and plugin menu
- **[App.svelte](0_App.svelte.md)** - Initializes plugin system on mount

### Backend Integration

- **[main.rs](12_main.rs.md)** - Plugin management commands (7 commands)
- **[manager.rs](11_manager.rs.md)** - Plugin lifecycle management
- **[api.rs](05_api.rs.md)** - Plugin API commands (18 commands)

### Related Frontend Files

- **[plugin-api.ts](09_plugin-api.ts.md)** - Plugin API types
- **[editor.ts](13_editor.ts.md)** - Emits events plugins can listen to
