# 3. debounce.ts - Debounce Utility
...
```text
FRONTEND TYPESCRIPT FILES (Complete Store & Utility Layer)
├─> editor.ts (THIS FILE #1 - 650 lines)
│   ├─> editor-loader.ts ✅
│   ├─> theme.ts ✅
│   ├─> debounce.ts (THIS FILE #3)
│   ├─> @tauri-apps/api
│   └─> svelte/store
│
├─> plugins.ts (THIS FILE #2 - 450 lines)
│   ├─> @tauri-apps/api
│   └─> svelte/store
│
└─> debounce.ts (THIS FILE #3 - 250 lines)
    └─> Pure TypeScript utility (no dependencies)
```
...
```text
┌────────────────────────────────────────────────────────────────┐
│           FRONTEND STORES & UTILITIES INTEGRATION              │
└────────────────────────────────────────────────────────────────┘
...
└──────────────────────────────────────────────────────────────┘
         │
         ├─> Manages open files & tabs
         ├─> Integrates with CodeMirror (editor-loader.ts)
         ├─> Auto-save with debounce
         ├─> File lifecycle (open/save/close)
...
└──────────────────────────────────────────────────────────────┘
         │
         ├─> Tracks plugin statuses
         ├─> Manages plugin commands
         ├─> Manages plugin panels
...
│  │                                                           │
│  ├─> StatusBar.svelte                                        │
│  │   └─> Uses pluginsStore.getStatusBarItems()               │
│  │                                                           │
│  ├─> Sidebar.svelte                                          │
│  │   └─> Uses pluginsStore.getPanels()                       │
│  │                                                           │
│  └─> CommandPalette.svelte                                   │
│      └─> Uses pluginsStore.getCommands()                     │
└──────────────────────────────────────────────────────────────┘
```
